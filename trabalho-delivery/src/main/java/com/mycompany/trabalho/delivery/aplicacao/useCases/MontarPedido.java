...
//    }
//    
//    public void executar(String cpf, List<ItemPedidoDTO> itens) {
...
//        Cliente cliente = repositorioClientes.buscarClientePorCPF(this.cpf);
//            if(cliente == null){
//                repositorioClientes.salvarCliente(cliente);
//            }
//        }
//        Pedido pedido = new Pedido(new ConsoleLogAdapter(), cpf, itens, new PedidoPendenteState());
